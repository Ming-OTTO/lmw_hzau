...
"""
dir_or_file
E:\\Project\\PaddleSeg\\data\\libox_xh\\label
output_dir
E:\\Project\\PaddleSeg\\data\\libox_xh\\label_color
"""
def parse_args():
        ...
        for fpath, dirs, fs in os.walk(input):
            for f in fs:
                try:
                    ...
                    _output_dir = _output_dir.lstrip(os.path.sep)  # lstrip是去掉左边的os.path.sep
                    ...
                    print('Error processing:', grt_path)
                    continue
