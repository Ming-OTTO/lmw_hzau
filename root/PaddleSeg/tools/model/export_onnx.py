...
# python tools\model\export_onnx.py --config bigbox/model/segformer_cotton_root_1024x1024_150k.yml  --model_path bigbox/model/bigseg1116/best_model/model.pdparams --save_dir output/onnx
def parse_args():
