...
class PhotoViewer(QGraphicsView):
    ...
    def draw_temp(self):
        ...
        rad = self.parent.brush_size
        color = 0 if self.parent.erase_mode else 255
        for x, y in self.temp_path:
    ...
    def commit_path(self):
        ...
        color = 0 if self.parent.erase_mode else 255
        for x, y in self.temp_path:
            cv2.circle(self.parent.current_img, (x, y), rad, color, -1)
        self._update_qpixmap(self.parent.current_img)
    ...
    def drawForeground(self, painter, rect):
        ...
        painter.drawEllipse(QPointF(self.mapToScene(self.mouse_pos)), rad, rad)
